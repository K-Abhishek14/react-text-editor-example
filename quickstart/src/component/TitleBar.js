...
var TitleBar = /** @class */ (function () {
	function TitleBar(element, docEditor, isShareNeeded, isRtl) {
		...
		this.initializeTitleBar = function (isShareNeeded) {
			...
			_this.save = _this.addButton('e-de-icon-Save e-de-padding-right', saveText, btnStyles, 'de-save', saveToolTip, false)
			var items = [
				{ text: 'Microsoft Word (.docx)', id: 'word' },
				{ text: 'Syncfusion Document Text (.sfdt)', id: 'sfdt' },
			];
			// tslint:disable-next-line:max-line-length
			// _this.export = _this.addButton('e-de-padding-right',saveText,btnStyles,'documenteditor-save',saveToolTip,true,);
		...
		this.wireEvents = function () {
			...
			_this.save.element.addEventListener('click', _this.onSave);
